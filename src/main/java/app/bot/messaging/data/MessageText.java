...
public enum MessageText {
    ...
    REGISTRATION_FOR_STARTING("🔷 1. Для начала зарегистрируйтесь по ссылке на сайте промокод FRUITHANTER " + LinkWrapper.wrapTextInLink("1WIN (CLICK)", "https://1wfqtr.life/?open=register&p=k31a") + "\n🔷 2. После успешной регистрации cкопируйте ваш айди на сайте (Вкладка 'пополнение' и в правом верхнем углу будет ваш ID).\n🔷 3. И отправьте его боту в ответ на это сообщение!"),
