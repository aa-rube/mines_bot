...
public class CallBackDataHandler {
    ...
    public void updateHandler(Update update) {
        ...
        executorService.submit(() -> pirateUserService.updateUserData(chatId, update, false));
        ...
        if (data.equals("registration") || data.equals("registration1")) {
            StateKeeper.putState(chatId, State.REGISTRATION);
            message.delete(chatId, msgId);
        ...
        if (data.contains("/admin_")) {
            ...
            if (data.contains("create_spam")) {
                ...
                StateKeeper.putState(chatId, State.SPAM);
                return;
            }
